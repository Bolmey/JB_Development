...
export default function Home() {
	return (
		<div class="flex w-full items-center flex-col">
			<section
				id="section1"
				class="flex justify-center item-center w-full bg-black md:p-10"
			>
			...
			<section
				id="section3"
				class="flex w-full justify-center items-center bg-graybg py-5 px-5 md:px-0"
			>
			...
			<section
				id="section4"
				class="flex w-full justify-center items-center bg-gray-100"
			>
